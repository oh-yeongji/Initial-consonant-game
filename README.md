...
- 룸 상태 실시간 동기화 및 시스템 메세지 알림
  ...
  - <img width="562" height="70" alt="image" src="https://github.com/user-attachments/assets/53c9d3db-ec89-4482-8f15-e9e8268c4442" />
...
- 인터랙티브 단축키 가이드 및 동적 애니메이션 연출
  - 2명 이상의 플레이어가 입장 시, 레디 버튼 내 안내 텍스트를 2초 주기로 전환(READY? <-> CTRL+ ↵)하여 유저의 단축키 인지율을 높였습니다.
